...
public final class BakerLibrary {
	...
	public static final BakerBlock SYMMETRIC_SENDER_FRAME = load(ResourceLibrary.SYMMETRIC_SENDER_FRAME);
	public static final BakerBlock SYMMETRIC_SENDER_CORE = load(ResourceLibrary.SYMMETRIC_SENDER_CORE);
	public static final BakerBlock SYMMETRIC_SENDER_RING = load(ResourceLibrary.SYMMETRIC_SENDER_RING);
	public static final BakerBlock SYMMETRIC_RECEIVER_FRAME = load(ResourceLibrary.SYMMETRIC_RECEIVER_FRAME);
	public static final BakerBlock SYMMETRIC_RECEIVER_GEAR_TOP = load(ResourceLibrary.SYMMETRIC_RECEIVER_GEAR_TOP);
	public static final BakerBlock SYMMETRIC_RECEIVER_GEAR_CENTER = load(ResourceLibrary.SYMMETRIC_RECEIVER_GEAR_CENTER);
	public static final BakerBlock SYMMETRIC_RECEIVER_GEAR_BOTTOM = load(ResourceLibrary.SYMMETRIC_RECEIVER_GEAR_BOTTOM);
	public static final BakerBlock SYMMETRIC_RECEIVER_CRYSTAL = load(ResourceLibrary.SYMMETRIC_RECEIVER_CRYSTAL);
