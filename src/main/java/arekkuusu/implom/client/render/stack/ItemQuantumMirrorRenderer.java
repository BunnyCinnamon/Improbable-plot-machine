...
public class ItemQuantumMirrorRenderer extends ItemRender {
	...
	public void renderByItem(ItemStack stack, float partialTicks) {
		...
		TileQuantumMirrorRenderer.renderMirror(tick, 0.75F, 0.5F, partialTicks);
		TileQuantumMirrorRenderer.renderMirror(-tick, 0.5F, 0.75F, partialTicks);
		TileQuantumMirrorRenderer.renderMirror(tick, -0.3F, 1F, partialTicks);
