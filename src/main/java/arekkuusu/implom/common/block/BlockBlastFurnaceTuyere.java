...
public class BlockBlastFurnaceTuyere extends BlockBaseHorizontal {

	public BlockBlastFurnaceTuyere() {
		super(LibNames.BLAST_FURNACE_TUYERE, IPMMaterial.FIRE_BRICK);
