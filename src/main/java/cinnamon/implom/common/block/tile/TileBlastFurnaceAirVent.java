...
public class TileBlastFurnaceAirVent extends TileMultiBlockOniichan {
    ...
    public TileBlastFurnaceAirVent(BlockPos arg2, BlockState arg3) {
    ...
    public static class Ticking implements BlockEntityTicker<TileBlastFurnaceAirVent> {

        @Override
        public void tick(Level arg, BlockPos arg2, BlockState arg3, TileBlastFurnaceAirVent instance) {
