...
import arekkuusu.implom.common.block.tile.TileBlastFurnaceInput;
...
public class BlockBlastFurnaceInput extends HorizontalBlock {
    ...
    public void onNeighborChange(BlockState state, IWorldReader world, BlockPos pos, BlockPos neighbor) {
        WorldHelper.getTile(TileBlastFurnaceInput.class, world, pos).ifPresent(TileBlastFurnaceInput::setupConnections);
    }
    ...
    public TileEntity createTileEntity(BlockState state, IBlockReader world) {
        return new TileBlastFurnaceInput();
    }
}
