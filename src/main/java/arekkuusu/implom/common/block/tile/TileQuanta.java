 ...
 */
public class TileQuanta extends TileBase implements ITickable {
	...
	public TileQuanta() {
		this.handler = new QuantaItemHandler(this);
	}
	...
	public static class QuantaItemHandler implements IItemHandler, IItemHandlerModifiable, INBTSerializable<NBTTagCompound> {

		private final TileQuanta tile;

		private QuantaItemHandler(TileQuanta tile) {
			this.tile = tile;
		}
