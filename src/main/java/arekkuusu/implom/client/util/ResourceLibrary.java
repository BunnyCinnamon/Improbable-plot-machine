...
public final class ResourceLibrary {
	...
	public static final ResourceLocation SYMMETRICAL_MACHINATION = getBlockTexture("symmetrical_machination/base");
	public static final ResourceLocation ASYMMETRICAL_MACHINATION = getBlockTexture("asymmetrical_machination/base");
	...
	public static final ResourceLocation SYMMETRICAL_MACHINATION_FRAME = getModel(ModelLocation.Obj(), "symmetrical_machination/frame");
	public static final ResourceLocation SYMMETRICAL_MACHINATION_CORE = getModel(ModelLocation.Obj(), "symmetrical_machination/core");
	public static final ResourceLocation SYMMETRICAL_MACHINATION_RING = getModel(ModelLocation.Obj(), "symmetrical_machination/ring");
	public static final ResourceLocation ASYMMETRICAL_MACHINATION_FRAME = getModel(ModelLocation.Obj(), "asymmetrical_machination/frame");
	public static final ResourceLocation ASYMMETRICAL_MACHINATION_GEAR_TOP = getModel(ModelLocation.Obj(), "asymmetrical_machination/gear_top");
	public static final ResourceLocation ASYMMETRICAL_MACHINATION_GEAR_CENTER = getModel(ModelLocation.Obj(), "asymmetrical_machination/gear_center");
	public static final ResourceLocation ASYMMETRICAL_MACHINATION_GEAR_BOTTOM = getModel(ModelLocation.Obj(), "asymmetrical_machination/gear_bottom");
	public static final ResourceLocation ASYMMETRICAL_MACHINATION_CRYSTAL = getModel(ModelLocation.Obj(), "asymmetrical_machination/crystal");
